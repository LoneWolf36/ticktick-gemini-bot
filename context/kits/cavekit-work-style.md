...
- [x] Audit R2 (Telegram Bot Interface): `/urgent`, `/focus`, `/normal`, `/mode`, and natural-language mode triggers now route through the unified work-style mode contract in `bot/commands.js` + `services/ax-intent.js`.
