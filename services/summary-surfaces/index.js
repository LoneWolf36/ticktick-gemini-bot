...
function normalizeSummaryRequestContext(kind, rawContext = {}) {
    ...
    return {
        kind: kind === WEEKLY_KIND ? WEEKLY_KIND : kind === DAILY_CLOSE_KIND ? DAILY_CLOSE_KIND : BRIEFING_KIND,
...
export { BRIEFING_SUMMARY_SECTION_KEYS, DAILY_CLOSE_SUMMARY_SECTION_KEYS, WEEKLY_SUMMARY_SECTION_KEYS, formatSummary };
